        ...
        >
          <div className="p-8 sm:p-10 flex flex-col gap-4 justify-center">
            ...
            <Link to="/produtos" className="inline-flex">
              <button className="inline-flex items-center gap-2 rounded-full border border-[var(--color-primary)] px-6 py-3 text-xs tracking-[0.3em] uppercase text-[var(--color-primary)] transition-colors hover:bg-[var(--color-primary)] hover:text-white font-bold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                {promo.cta}
